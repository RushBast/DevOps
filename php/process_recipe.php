...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $image_path)) {
        ...
        $image_sql = "INSERT INTO images (filename, filepath, recipe_id) VALUES ('$filename', '$filepath', '$recipe_id')";
        ...
        if ($conn->query($image_sql) === TRUE) {
            ...
            if ($conn->query($recipe_sql) === TRUE) {
                ...
                $update_image_sql = "UPDATE images SET recipe_id = '$recipe_id' WHERE recipe_id = '$recipe_id'";
